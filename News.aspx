<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News.aspx.cs" Inherits="prjUnisoft_.News" %>
...
<body>
    ...
    <div style="text-align:center;margin-top:20px">
        ...
        <asp:TextBox ID="txtNews" runat="server" placeholder="News"></asp:TextBox>
        ...
        <div style="margin-left:725px;overflow-y:scroll;height:500px">
        <asp:GridView ID="grvNews" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
